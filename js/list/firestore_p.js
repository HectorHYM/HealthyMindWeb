...
//*Obtiene los documentos y datos de los registros de la colección de pacientes
export const loadUserData = async () => {
    try{
        const querySnapshot = await getDocs(collection(db, 'users-paciente'));
        const registers = [];
...
export const deleteUser = async (id) => {
    try{
        await deleteDoc(doc(db, "users-paciente", id));
